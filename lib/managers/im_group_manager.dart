...
class ImGroupManager {
  ...
  static Future<void> joinGroup({@required String groupID, @required String message}) =>
      TencentImPlugin.joinGroup(groupID: groupID, message: message);

  /// 退出群
  /// [groupID] 群ID
  static Future<void> quitGroup({@required String groupID}) => TencentImPlugin.quitGroup(groupID: groupID);

  /// 解散群
  /// [groupID] 群ID
  static Future<void> dismissGroup({@required String groupID}) => TencentImPlugin.dismissGroup(groupID: groupID);

  /// 获取已经加入的群列表（不包括已加入的直播群）
  static Future<List<GroupInfoEntity>> getJoinedGroupList() => TencentImPlugin.getJoinedGroupList();

  /// 拉取群资料
  /// [groupIDList] 群ID列表
  static Future<List<GroupInfoResultEntity>> getGroupsInfo({@required List<String> groupIDList}) =>
      TencentImPlugin.getGroupsInfo(groupIDList: groupIDList);

  /// 修改群资料
  /// [info] 群信息
  static Future<void> setGroupInfo({@required GroupInfoEntity info}) => TencentImPlugin.setGroupInfo(info: info);

  /// 修改群消息接收选项
  /// [groupID] 群ID
  /// [opt] 消息接收选项
  static Future<void> setReceiveMessageOpt({@required String groupID, @required GroupReceiveMessageOptEnum opt}) =>
  ...
  static Future<void> initGroupAttributes({@required String groupID, @required Map<String, String> attributes}) =>
      TencentImPlugin.initGroupAttributes(groupID: groupID, attributes: attributes);

  /// 设置群属性。已有该群属性则更新其 value 值，没有该群属性则添加该属性。
  /// [groupID] 群ID
  /// [attributes] 群属性
  static Future<void> setGroupAttributes({@required String groupID, @required Map<String, String> attributes}) =>
  ...
  static Future<void> deleteGroupAttributes({@required String groupID, List<String> keys}) =>
      TencentImPlugin.deleteGroupAttributes(groupID: groupID, keys: keys);

  /// 获取指定群属性，keys 传 null 则获取所有群属性。
  /// [groupID] 群ID
  /// [keys] 群属性Key,keys 传 null 则清空所有群属性。
  static Future<Map<String, String>> getGroupAttributes({@required String groupID, List<String> keys}) =>
      TencentImPlugin.getGroupAttributes(groupID: groupID, keys: keys);

  /// 获取指定群在线人数
  /// [groupID] 群ID
  static Future<int> getGroupOnlineMemberCount({@required String groupID}) => TencentImPlugin.getGroupOnlineMemberCount(groupID: groupID);
  ...
  /// [groupID] 群ID
  /// [memberList] 群成员列表
  static Future<List<GroupMemberEntity>> getGroupMembersInfo({@required String groupID, @required List<String> memberList}) =>
  ...
  /// [groupID] 群ID
  /// [userList] 用户ID列表
  static Future<List<GroupMemberOperationResultEntity>> inviteUserToGroup({@required String groupID, @required List<String> userList}) =>
  ...
  /// [userID] 用户ID
  /// [role] 角色
  static Future<void> setGroupMemberRole({
    @required String groupID,
    @required String userID,
  ...
  /// 获取加群的申请列表
  static Future<GroupApplicationResultEntity> getGroupApplicationList() => TencentImPlugin.getGroupApplicationList();
  ...
  /// 标记申请列表为已读
  static Future<void> setGroupApplicationRead() => TencentImPlugin.setGroupApplicationRead();
}
