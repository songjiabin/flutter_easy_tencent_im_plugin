...
class ImConversationManager {
  ...
  static Future<ConversationResultEntity> getConversationList({int nextSeq: 0, int count: 100}) =>
  ...
  /// [userID] 用户ID
  /// [groupID] 群ID
  static Future<ConversationEntity> getConversation({String conversationID, String userID, String groupID}) =>
